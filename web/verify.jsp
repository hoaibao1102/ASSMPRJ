...
<html>
    ...
    <body>
        ...
        <div class="verify-container">
            ...
            <p>We’ve sent a verification code to <strong>your-email@example.com</strong>.<br>
            ...
            <form action="regisController" method="get">
                ...
                <input type="submit" class="verify-btn" value="Verifyemail" disabled id="verifyBtn">
            </form>

            <div class="links">
                <p>Didn’t receive an email? Please check your spam folder or request another code in 15 seconds</p>
                <p><a href="login.jsp">Back to sign in</a></p>
            </div>
