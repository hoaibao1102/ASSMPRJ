...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (requestURI.contains("/BookingStep1.jsp") || requestURI.contains("/BookingStep2.jsp")
                ...
                || requestURI.contains("/createTicketForm.jsp") || requestURI.contains("/voucherForm.jsp")|| requestURI.contains("/favoriteList.jsp")) {

            if (!UTILS.AuthUtils.isLoggedIn(session)) {
                httpRequest.setAttribute("errorMessage", "Please log in to access this page.");
                httpRequest.getRequestDispatcher("LoginForm.jsp").forward(request, response);
                return;
            }
        }
