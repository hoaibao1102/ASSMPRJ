...
public class CustomerFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (requestURI.contains("/BookingStep1.jsp") || requestURI.contains("/BookingStep2.jsp")
                || requestURI.contains("/BookingStep3.jsp")) {

            
            if (!UTILS.AuthUtils.isCustomer(session)) {
                httpRequest.setAttribute("errorMessage", "You don't have permission to access this page. Customer access required.");
                httpRequest.getRequestDispatcher("placeController?action=destination&page=indexjsp").forward(request, response);
                return;
            }
        }
