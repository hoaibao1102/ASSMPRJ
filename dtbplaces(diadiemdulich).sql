...
UPDATE Places SET img_places = 'hanoiimg.jpg' WHERE idplace = 12;
UPDATE Places SET img_places = 'dalatimg.webp' WHERE idplace = 4;
UPDATE Places SET img_places = 'danang2img.jpg' WHERE idplace = 5;
...
-- Insert chi tiết tour Nha Trang 3 ngày(26-05-25)
INSERT INTO TourDetail (idTour, day1descrip, day2descrip, day3descrip, imgDetail) VALUES
('NT002',
  N'Ngày 1: TP.HCM – NHA TRANG – THÁP BÀ#Buổi sáng:# 
  Khởi hành sớm từ TP.HCM đến Nha Trang bằng xe hoặc máy bay./ 
